 ...
 *
 * CoAtionOS is a real-time, embedded operating system for the ARM Cortex-M3 architecture.  It features:
 *  - Easy-to-learn, POSIX Style API
 *  - A multi-tasking, pre-emptive kernel (including threads and memory protected
 * processes)
 ...
 * \ref MQUEUE, pthread and \ref PTHREAD_MUTEX APIs as well as with the filesystem (see \ref SYS_FIFO).
 *
 ...
 *
 * The USB user interface is accessed using the CoActionOS Link cross-platform GUI application
 * (see the <a href="http://www.coactionos.com/getting-started.html">Getting Started</a> page).  Additionally, many aspects of the
 * operating system can be accessed over USB using the hardware abstraction layer
 * (see <a href="http://www.coactionos.com/swdoc/hwpl/html/group___u_s_b_l_i_n_k.html">
 * HWPL USB Link</a>).  This includes direct access to microcontroller peripherals and devices.  Custom desktop applications
 * can share data with embedded programs using FIFOs (see \ref SYS_FIFO).
 *
 * \section GETTING_STARTED Getting Started
 *
 * To start using CoActionOS, see the <a href="http://www.coactionos.com/getting-started.html">Getting Started</a> page.
 * Or jump straight to the first <a href="http://www.coactionos.com/getting-started/18-coactionos-tutorials/32-hello-world-tutorial.html">
 * tutorial</a>.
 *
 ...
 * and peripherals.  For example, this layer includes drivers for the on-chip UART and the on-chip clock control.
 ...
 * - STM32F MCU Series from STMicroelectronics
 * - Stellaris MCU Series from Texas Instruments
 *
 */
